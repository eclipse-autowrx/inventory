...
export const types = [
  ...
  },
  {
    ...
    description:
      'A sequence of events or interactions that a customer experiences with the vehicle.',
    type: 'object',
  },
  {
    $id: 'step',
    title: 'Step',
    description: 'A specific action or event within a customer journey.',
    type: 'object',
  },
  {
    $id: 'flow',
    title: 'Flow',
    description:
      'A series of interconnected steps or actions that form a complete process.',
    type: 'object',
  },
  {
    $id: 'system_activity',
    ...
    description:
      'A specific function or operation performed by the system or its components.',
    type: 'object',
  },
];
...
export const instances: InventoryItem[] = [
  {
    ...
    data: {
      name: 'Initialize Proximity Sensors; these will be used by open door',
      Type: 'System Initialize',
      Component: 'System Control',
      Description:
        'Initialize Proximity Sensors; these will be used by open door',
      'Pre-Mitigation ASIL': 'ASIL-B',
      'Post-Mitigation ASIL': 'QM',
      'Hazard Analysis and Risk Assessment:': `
Hazards:
Sensor initialization failure leading to the absence of reliable proximity data.
Delayed or incorrect sensor readiness causing premature or delayed door activation.
False positive or false negative detection resulting in unintended door motion.
Unexpected door operation increasing the risk of collisions with pedestrians or nearby objects.
Mitigation:
Redundant initialization checks to verify sensor hardware and software integrity.
Self-diagnostic algorithms to continuously monitor sensor performance.
Fail-safe mechanisms to default the door to a safe state upon sensor fault detection.
Robust error handling routines to reinitiate sensor calibration and initialization.
Risk Classification:
Severity: S2 (Potential for moderate injuries if the door operates unexpectedly).
Exposure: E3 (Regular door usage increases the likelihood of encountering this failure mode).
Controllability: C2 (Limited ability for immediate corrective action by the user).
ASIL Rating:
Pre Mitigation: ASIL-B, owing to the combination of moderate severity, frequent exposure, and restricted controllability.
Post Mitigation: ASIL QM, as the implemented safety measures substantially reduce the risk to a level manageable under quality management processes.
Safety Goals:
Guarantee reliable sensor initialization to ensure accurate proximity detection.
Implement immediate fault detection and safe state transition protocols.
Maintain continuous system integrity through rigorous monitoring and diagnostics.
Generated by AI on 18/02/2025 15:39:35`,
    },
  },
  {
    id: 'flow1',
    type: 'flow',
    data: {
      name: 'Flow Item 1 - Step 1 - Passenger Welcome',
      description: 'Description of Flow Item 1',
  ...
  },
  {
    ...
    type: 'step',
    data: {
      name: 'Step1: driver proximity detected',
      description:
        'Driver approaches the vehicle and is detected by the system.',
      createdAt: '2025-03-11T12:00:00Z',
      updatedAt: '2025-03-11T12:05:00Z',
      createdBy: {
        name: 'Luong Nguyen Nhan (MS/PJ-ETA-Innov)',
  ...
  },
  {
    ...
    data: {
      ...
      description:
        'The sequence of events that occurs when a passenger approaches the vehicle, including door opening, ambient light adjustment, seat adjusting and configuration.',
      createdAt: '2025-03-11T12:00:00Z',
      updatedAt: '2025-03-11T12:05:00Z',
      createdBy: {
        name: 'Luong Nguyen Nhan (MS/PJ-ETA-Innov)',
